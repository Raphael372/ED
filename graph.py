...
class Grafo():
    ...
    def calcular_melhores_caminhos_partindo_de(self,cidade):
        ...
        while arcos:
            ...
            info_caminho[visitados[-1]] = arco[0], info_caminho[cidade_vizinha][1] + [arco[1].valor] + [visitados[-1]]
            ...
            for posicao in range(len(self.arco)):
                if visitados[-1] in self.arco[posicao].vertices and (self.arco[posicao].vertices[0] not in visitados or self.arco[posicao].vertices[1] not in visitados):
                    arcos.append((info_caminho[visitados[-1]][0]+ self.arco[posicao].valor,self.arco[posicao]))
...
class GrafoTestes(unittest.TestCase):
    ...
    def teste_melhor_caminho_partindo_de_taubate_considerando_custo(self):
        ...
        preco_gasolina = 3.65  
        rendimento_carro_popular = 15000  
        preco_por_distancia = preco_gasolina / rendimento_carro_popular  
