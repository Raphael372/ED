...
class Lista():
    ...
    def __iter__(self):
        nohAtual = self.primeiro
        while nohAtual !=  None:
            yield nohAtual.valor
            nohAtual = nohAtual.direito
        pass
    ...
    def adicionar(self, valor):
        ...
        if self.tam == 0:
            ...
            while ultimo.direito != None:
                ultimo = ultimo.direito
            self.ultimo.direito = noh
            aux = self.ultimo
            self.ultimo = noh
            self.ultimo.esquerdo = aux
        self.tam=self.tam+1
    ...
    def adicionar_a_esquerda(self, valor):
        ...
        if self.tam ==0:
            ...
            while primeiro.esquerdo != None:
                primeiro = primeiro.esquerdo
            primeiro.esquerdo = noh
            aux = self.primeiro
            self.primeiro = noh
            self.primeiro.direito = aux
        self.tam=self.tam+1
    ...
    def remover(self):
                if self.tam == 0:
                    ...
                    valorRemove = self.ultimo.valor
                    self.ultimo = self.primeiro.direito
    ...
    def remover_a_esquerda(self):
            if self.tam == 0:
                ...
                valorRemove = self.primeiro.valor
